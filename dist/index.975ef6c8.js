...
const handleInput = (0, _lodash.debounce)(()=>{
    ...
    if (countryName.length === 0) (0, _notiflixNotifyAio.Notify).failure("The input field cannot be empty");
    else (0, _fetchCountriesJs.fetchCountryData)(countryName).then((data)=>{
        result.innerHTML = `
...
},{"lodash":"3qBDj","./fetchCountries.js":"fTQqv","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
