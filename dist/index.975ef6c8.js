...
const handleInput = (0, _lodash.debounce)(()=>{
    ...
    if (countryName.length === 0) result.innerHTML = `<h3>The input field cannot be empty</h3>`;
...
},{"lodash":"3qBDj","./fetchCountries.js":"fTQqv"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
