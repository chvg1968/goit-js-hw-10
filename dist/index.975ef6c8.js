...
const handleInput = (0, _lodash.debounce)(()=>{
    const countryName1 = countryInp.value.trim();
    if (countryName1.length === 0) {
        (0, _notiflixNotifyAio.Notify).failure("The input field cannot be empty");
        suggestionsList.innerHTML = "";
    } else {
        (0, _fetchCountriesJs.fetchCountryData)(countryName1).then((data)=>{
            result.innerHTML = `
        ...
        `;
            ...
            (0, _notiflixNotifyAio.Notify).failure("Please enter a valid country name");
        });
        fetch(`https://restcountries.com/v3.1/name/${countryName1}`).then((response)=>response.json()).then((data)=>{
            suggestionsList.innerHTML = "";
            const numCountries = data.length;
            if (numCountries > 10) {
                const tooManyMatches = document.createElement("li");
                (0, _notiflixNotifyAio.Notify).failure(`Too many matches found. Please be more specific.`);
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","lodash":"3qBDj","./fetchCountries.js":"fTQqv"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
parcelHelpers.export(exports, "fetchCountryData", ()=>fetchCountryData);
...
},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequire7bc7")
